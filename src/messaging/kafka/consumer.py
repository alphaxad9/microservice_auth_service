...
from src.messaging.kafka.dispatchers.profile.dispatchers import PROFILE_EVENT_HANDLERS
from src.messaging.kafka.dispatchers.user.dispatcher import USER_EVENT_HANDLERS
